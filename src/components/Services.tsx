...
import { Users, ShoppingBag, Target, BarChart, Rocket, Phone, MessageCircle, ArrowRight } from 'lucide-react';
...
export default function Services() {
  ...
  const services = [
    {
      title: t('services.sections.eventMarketing.title'),
      description: t('services.sections.eventMarketing.description'),
      icon: Users,
      features: [t('services.sections.eventMarketing.features.feature1'), t('services.sections.eventMarketing.features.feature2')],
      path: '/services/event-marketing'
    },
    {
      title: t('services.sections.minisites.title'),
      description: t('services.sections.minisites.description'),
      icon: ShoppingBag,
      features: [t('services.sections.minisites.features.feature1'), t('services.sections.minisites.features.feature2')],
      path: '/services/minisites'
    },
    {
      title: t('services.sections.ads.title'),
      description: t('services.sections.ads.description'),
      icon: Target,
      features: [t('services.sections.ads.features.feature1'), t('services.sections.ads.features.feature2')],
      path: '/services/ads'
    },
    {
      ...
      icon: BarChart,
      features: [t('services.sections.analytics.features.feature1'), t('services.sections.analytics.features.feature2')],
    ...
    },
    {
      ...
      icon: Rocket,
      features: [t('services.sections.instantWebsites.features.feature1'), t('services.sections.instantWebsites.features.feature2')],
    ...
    <div className="py-12 bg-white">
      ...
      >
        <div className="lg:text-center">
          ...
          >
            {t('services.subtitle_event_marketing')}
          </motion.p>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            {t('services.description_event_marketing')}
          </motion.p>
        </div>
